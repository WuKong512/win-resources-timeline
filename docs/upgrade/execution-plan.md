...
harness or runtime exists, and no treatment may follow CONTROL drift. The
...
~~~text
AMD_LOCALSERVICE_ACTIVE_SAMPLING_HARNESS_I1 = REVIEW_FIX_R2_COMPLETE
...
PRODUCTION_ACCOUNT = UNRESOLVED
AMD_PRODUCTION_ADMISSION = DEFER
SELECTED_NEXT_TASK = HUMAN_REVIEW_PR29_AFTER_R2
NEXT_GATE = HUMAN_REVIEW_PR29_AFTER_R2
AMD_CLI_REAL_INVOCATIONS = 0
AMD_API_REAL_INVOCATIONS = 0
POWER_SAMPLING_RUNS = 0
