...
## HISTORICAL / SUPERSEDED — Q1 decision snapshot

The following decision block records the state when Q1 completed. D1 has now
performed the human-reviewed follow-up; the authoritative current-state
handoff is at the end of this document.
