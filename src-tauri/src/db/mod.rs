            ...
            writer::insert_resource_snapshot(
                ...
                &ResourceSnapshot {
                    ...
                    apps: vec![AppResourceSample {
                        ...
                        selection_reason: 0,
                        quality_mask: 0,
                        measured_cpu_percent: Some(5.0),
                        measured_working_set_bytes: Some(10),
                        measured_read_bytes_per_sec: Some(1),
                        measured_write_bytes_per_sec: Some(2),
                    }],
                },
            )
        })
    ...
    fn resource_snapshot_round_trip_and_retention_cascade() {
        ...
        let snapshot = ResourceSnapshot {
            ...
            apps: vec![AppResourceSample {
                ...
                selection_reason: 0,
                quality_mask: 0,
                measured_cpu_percent: Some(70.0),
                measured_working_set_bytes: Some(900),
                measured_read_bytes_per_sec: Some(250),
                measured_write_bytes_per_sec: Some(350),
            }],
        };
        ...
        for (timestamp_ms, version, cpu_percent) in [(10_000, "26.1", 10.0), (20_000, "26.2", 20.0)]
        {
            ...
            let snapshot = ResourceSnapshot {
                ...
                apps: vec![AppResourceSample {
                    ...
                    selection_reason: 0,
                    quality_mask: 0,
                    measured_cpu_percent: Some(cpu_percent),
                    measured_working_set_bytes: Some(900),
                    measured_read_bytes_per_sec: Some(250),
                    measured_write_bytes_per_sec: Some(350),
                }],
