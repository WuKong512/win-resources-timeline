...
NEXT_TASK = AMD-RUNTIME-PREREQUISITE-AUDIT-Q1
POST_I2G_DECISION = docs/upgrade/amd-post-i2g-production-admission.md
OPERATION_PATH_AUDIT = docs/upgrade/amd-cli-list-path-validity.md
...
The Q1 runtime prerequisite audit is complete as an offline-only
characterization. The detailed source of truth is
[docs/upgrade/amd-runtime-prerequisite-audit-q1.md](../../docs/upgrade/amd-runtime-prerequisite-audit-q1.md).
This README marker is the final current handoff after the inherited historical
qualification sections. Historical qualification instructions and evidence
remain unchanged; no qualification test is authorized by this marker.
